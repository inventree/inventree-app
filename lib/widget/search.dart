        ...
        ListTile(
          ...
          onTap: () {
            Navigator.push(
              ...
              MaterialPageRoute(
                builder:
                    (context) => PartCategoryList({"original_search": query}),
              ),
            );
          },
        ),
        ...
        ListTile(
          ...
          onTap: () {
            Navigator.push(
              ...
              MaterialPageRoute(
                builder:
                    (context) => StockLocationList({"original_search": query}),
              ),
            );
          },
        ),
        ...
        ListTile(
          ...
          onTap: () {
            Navigator.push(
              ...
              MaterialPageRoute(
                builder:
                    (context) => PurchaseOrderListWidget(
        ...
        ListTile(
          ...
          onTap: () {
            Navigator.push(
              ...
              MaterialPageRoute(
                builder:
                    (context) => CompanyListWidget(L10().companies, {
        ...
        ListTile(
          ...
          onTap: () {
            Navigator.push(
              ...
              MaterialPageRoute(
                builder:
                    (context) => CompanyListWidget(L10().manufacturers, {
                      "original_search": query,
        ...
        ListTile(
          ...
          onTap: () {
            Navigator.push(
              ...
              MaterialPageRoute(
                builder:
                    (context) => CompanyListWidget(L10().suppliers, {
                      "original_search": query,
                      "is_supplier": "true",
                    }),
              ),
        ...
        ListTile(
          ...
          onTap: () {
            Navigator.push(
              ...
              MaterialPageRoute(
                builder:
                    (context) => SupplierPartList({"original_search": query}),
              ),
            );
          },
        ),
